    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFFE53935), Color(0xFFC45F70)],
            ...
            children: [
              ...
              Expanded(
                child: Observer(builder: (_) {
                          ...
                          children: [
                            ...
                            Center(
                              child: ElevatedButton.icon(
                                ...
                                label: const Text('Como chegar', style: TextStyle(color: Colors.white)),
                  ...
                  return const Center(
                    child: Text('Digite um CEP para começar', style: TextStyle(color: Colors.white70)),
                  );
                }),
              ),
            ],
